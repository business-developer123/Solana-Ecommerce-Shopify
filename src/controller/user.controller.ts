...
export const UserController = {
    ...
    transferNFT: async (req: Request, res: Response) => {
        try {
            ...
            if (!getUserInfo || getUserInfo.length === 0 || getUserInfo[0].privatekey === null || getUserInfo[0].privatekey === undefined || getUserInfo[0].privatekey.length === 0) {
            ...
            if (!transferNFT) {
                throw new Error('NFT transferring failed');
            }
